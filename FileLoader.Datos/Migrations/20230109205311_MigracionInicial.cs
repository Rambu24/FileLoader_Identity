    ...
    public partial class MigracionInicial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Codigo_Reporte = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Catalogo_ReportesCLS", x => x.Codigo_Reporte);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Indice = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    CodigoReporte = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CodigoCuenta = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    NombreCuenta = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    SaldoAlDia = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
                    SaldoDiaAnterior = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
                    Variacion = table.Column<decimal>(type: "decimal(18,2)", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_BalanceFocrede", x => x.Indice);
                    table.ForeignKey(
                        name: "FK_BalanceFocrede_DatosReporte_Id_Reporte",
                        column: x => x.Id_Reporte,
                        principalTable: "DatosReporte",
                        principalColumn: "Indice");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BalanceFocrede_Id_Reporte",
                table: "BalanceFocrede",
                column: "Id_Reporte");

            migrationBuilder.CreateIndex(
                name: "IX_DatosReporte_CodigoReporte",
                table: "DatosReporte",
